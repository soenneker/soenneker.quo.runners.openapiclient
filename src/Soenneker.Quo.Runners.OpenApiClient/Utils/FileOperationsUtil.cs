...
using Soenneker.Quo.Runners.OpenApiClient.Utils.Abstract;
...
namespace Soenneker.Quo.Runners.OpenApiClient.Utils;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string? filePath = await _fileDownloadUtil.Download("https://openphone-public-api-prod.s3.us-west-2.amazonaws.com/public/openphone-public-api-v1-prod.json",
      ...
      //  await _openApiFixer.Fix(filePath, fixedFilePath, cancellationToken).NoSync();
        ...
        await _processUtil.Start("kiota", gitDirectory, $"kiota generate -l CSharp -d \"{filePath}\" -o src/{Constants.Library} -c QuoOpenApiClient -n {Constants.Library}",
